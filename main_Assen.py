...
# Export parameters
filename_exp = 'Python_sim_Assen.mat'
structure_exp = 'Assen_sim'
# Import filenames
filename_ref_lap = 'Assen_Race_pretend.mat'
filename_ref_map = 'Assen_Race_pretend.mat'
filename_ref_brake = 'Assen_Race_pretend.mat'
structure_map = 'Assen_Map'
structure_lap = 'Assen_Race'
...
TT_Sim = {'N': ([73.0, 17.0]),
          'constants': {'Km': 300 / 660 / 2, 'cd': 0.38, 'area': 1, 'rho': 1.204, 'm': 215.0-4 + 90, 'p_tyre': 1.9,
                        'r': 2.003 / 2 / np.pi},
          'J': {'wheel': 1.1, 'motor': 0},
...
L_core = 175
TT_Sim['motor'] = {}
TT_Sim['motor']['T_max'] = 700 * TT_Sim['constants']['Km']
TT_Sim['motor']['W_max'] = 9000 / 30 * np.pi
TT_Sim['motor']['W_lim'] = 9500 / 30 * np.pi
