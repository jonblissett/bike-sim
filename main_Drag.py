...
# Export parameters
filename_exp = 'Python_sim_Drag.mat'
structure_exp = 'Drag_sim'
# Import filenames
filename_ref_lap = 'Drag_Race_pretend.mat'
filename_ref_map = 'Drag_Race_pretend.mat'
filename_ref_brake = 'Drag_Race_pretend.mat'
...
TT_Sim = {'N': ([79.0, 21.0]),
          'constants': {'cd': 0.38, 'area': 1, 'rho': 1.204, 'm': 205.0 + 90, 'p_tyre': 1.9,
                        'r': 2.003 / 2 / np.pi},
          'J': {'wheel': 1.1, 'motor': 0},
...
turns = 4.5
L_core = 400
TT_Sim['constants']['Km'] = 257/977 * turns / 11.5 * L_core / 150
TT_Sim['motor'] = {}
TT_Sim['motor']['T_max'] = 700
print('Motor peak current = ', TT_Sim['motor']['T_max']/TT_Sim['constants']['Km'])
TT_Sim['motor']['W_max'] = 10800 / 30 * np.pi
TT_Sim['motor']['W_lim'] = 11000 / 30 * np.pi
TT_Sim['motor']['P_max'] = 800000  # 50500
TT_Sim['motor']['poles'] = 12
TT_Sim['motor']['Ld'] = 53e-6 * (turns/11.5)**2 * L_core / 150
TT_Sim['motor']['Lq'] = 61e-6 * (turns/11.5)**2 * L_core / 150
print('Motor Lq (uH) = ', TT_Sim['motor']['Lq'] * 1e6)
...
print('Distance = ', integrate.cumtrapz(TT_Sim.v, TT_Sim.t)[-1])
