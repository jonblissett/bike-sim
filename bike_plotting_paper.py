...
Data_A = bike.energy_losses('Python_sim_Portimao_A.mat', 'Portimao_sim_A', IR)
...
Data_C = bike.energy_losses('Python_sim_Portimao_DM2.mat', 'Portimao_sim_DM2', IR)
Data_D = bike.energy_losses('Python_sim_Portimao_D.mat', 'Portimao_sim_D', IR)
...
plt.show()
plt.savefig('Python_pie_losses.pgf')
...
plt.show()
plt.savefig('Python_bar_losses.pgf')
...
plt.show()
plt.savefig('Python_stack_losses.pgf')
