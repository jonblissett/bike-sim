...
last_corner = 2    # 7#63  # set to large number to use all
...
ax1.plot(Ref_Race.Distance, v, TT_Sim.Distance, TT_Sim.v, 'b-')
...
ax2 = ax1.twinx()
ax2.plot(Ref_Race.Distance, Ref_Race.Iq*TT_Sim.constants.Km, TT_Sim.Distance, TT_Sim.Iq*TT_Sim.constants.Km, 'g-')
ax2.set_ylabel('Motor Torque (Nm)', color='r')
