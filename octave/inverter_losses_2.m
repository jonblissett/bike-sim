...
function [Ptotal, Pct, Pcd, Pst, Psd, i_ripple] = inverter_losses_2(Vbus,Voll,Iorms,PF,L,f_sw,u_ce0,u_d0,r_c,r_d,Eton,Etoff,Ed,Vce_test,Ic_test)
    ...
    %Pst = (Eton.*Icon.^2./(Ic_test.^2)+Etoff.*Icoff/Ic_test).*f_sw./Vce_test.*Vbus;
    Pst = (Eton.*Icon./Ic_test+Etoff.*Icoff/Ic_test).*f_sw./Vce_test.*Vbus;    % Test at Vce=300V, Ic=550A
    Psd = Ed.*f_sw./Vce_test.*Vbus./Ic_test.*Idc;
